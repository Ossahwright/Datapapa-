import { findNetworkConfig } from './networkConfig';

export interface BundleDefinition {
  id: string;
  displayLabel: string;
  networkId: string; // Internal network ID (MTN, AIRTELTIGO_PREMIUM, etc.)
  providerNetworkKey: string; // The key required by DataHub API (YELLO, AT_PREMIUM, etc.)
  providerCapacity: string; // The capacity value required by DataHub API (1, 2, 5, etc.)
  price: number;
}
